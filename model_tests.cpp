...
int main(size_t, const char**)
{
    ...
    }
    {
        ...
        i7::put(nodeResult, 121);
        assert(i7::get(nodeResult) == 121);
        sysex = i7::createSysexData(nodeResult, 23);
    ...
    }
    {
        ...
        i7::put(nodeResult, 2024);
        assert(i7::get(nodeResult) == 2024);
        auto sysex = i7::createSysexData(nodeResult);
    ...
    }
    {
        ...
        i7::put(nodeResult, 250);
        assert(i7::get(nodeResult) == 250);
        auto sysex = i7::createSysexData(nodeResult);
        auto strSysex = bytesToString(sysex.cbegin(), sysex.cend());
