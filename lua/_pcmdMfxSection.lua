    ...
    grp = {
        {
            ...
            params = {
                ...
                {type="range",  id=idTmpl("RFRF_MFX_CTRL1_SRC"),  name=get("MFX Control 1 Source"),  default=0,   min=get(0), max=get(101)},
                {type="range",  id=idTmpl("RFRF_MFX_CTRL1_SENS"), name=get("MFX Control 1 Sens"),    default=64,  min=get(1), max=get(127)},
                {type="range",  id=idTmpl("RFRF_MFX_CTRL2_SRC"),  name=get("MFX Control 2 Source"),  default=0,   min=get(0), max=get(101)},
                {type="range",  id=idTmpl("RFRF_MFX_CTRL2_SENS"), name=get("MFX Control 2 Sens"),    default=64,  min=get(1), max=get(127)},
                {type="range",  id=idTmpl("RFRF_MFX_CTRL3_SRC"),  name=get("MFX Control 3 Source"),  default=0,   min=get(0), max=get(101)},
                {type="range",  id=idTmpl("RFRF_MFX_CTRL3_SENS"), name=get("MFX Control 3 Sens"),    default=64,  min=get(1), max=get(127)},
                {type="range",  id=idTmpl("RFRF_MFX_CTRL4_SRC"),  name=get("MFX Control 4 Source"),  default=0,   min=get(0), max=get(101)},
                {type="range",  id=idTmpl("RFRF_MFX_CTRL4_SENS"), name=get("MFX Control 4 Sens"),    default=64,  min=get(1), max=get(127)},
            }
        },
        {
            name = "MFX",
...
function CreateMfxPcmdSections(main)
    for partNr = 1, 16, 1 do
        local k = "Part " .. string.format("%02d", partNr) .. " PCM-D MFX"
