...
local mfxCtrlIds = {
    { src = "SDKF_MFX_CTRL1_SRC", sens = "SDKF_MFX_CTRL1_SENS" },
    { src = "SDKF_MFX_CTRL2_SRC", sens = "SDKF_MFX_CTRL2_SENS" },
    { src = "SDKF_MFX_CTRL3_SRC", sens = "SDKF_MFX_CTRL3_SENS" },
    { src = "SDKF_MFX_CTRL4_SRC", sens = "SDKF_MFX_CTRL4_SENS" },
}

function CreateMfxSndSections(main)
    for partNr = 1, 16, 1 do
        local pn     = string.format("%02d", partNr)
        local prefix = "Part " .. pn .. " SN-D MFX"
