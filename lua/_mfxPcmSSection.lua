...
local mfxCtrlIds = {
    { src = "RFPF_MFX_CTRL1_SRC", sens = "RFPF_MFX_CTRL1_SENS" },
    { src = "RFPF_MFX_CTRL2_SRC", sens = "RFPF_MFX_CTRL2_SENS" },
    { src = "RFPF_MFX_CTRL3_SRC", sens = "RFPF_MFX_CTRL3_SENS" },
    { src = "RFPF_MFX_CTRL4_SRC", sens = "RFPF_MFX_CTRL4_SENS" },
}

function CreateMfxPcmSSections(main)
    for partNr = 1, 16, 1 do
        local pn     = string.format("%02d", partNr)
        local prefix = "Part " .. pn .. " PCM-S MFX"
